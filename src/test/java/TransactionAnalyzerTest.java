...
class TransactionAnalyzerTest {
    ...
    public void testCalculateTotalBalance() {
        ...
        Transaction transaction2 = new Transaction("2023-02-15", -50.0, "Витрата"); // Виправлено формат дати
        Transaction transaction3 = new Transaction("2023-03-05", 150.0, "Дохід");
